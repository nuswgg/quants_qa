...
api = TqApi(TqSim(init_balance=100000),backtest=TqBacktest(start_dt=date(2021, 3, 5), end_dt=date(2021, 3, 24)),web_gui="http://172.16.83.232:9876", auth=TqAuth("nuswgg", "541278"))
