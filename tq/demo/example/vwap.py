...
api = TqApi(TqSim(init_balance=100000), backtest=TqBacktest(start_dt=date(2021, 3, 1), end_dt=date(2021, 4, 2)),web_gui="http://192.168.1.4:9876", auth=TqAuth("nuswgg", "541278"))
print("策略开始运行")
...
# TARGET_VOLUME = round(acct.available * 10 / (margin * price))
...
if time_slot_end > time_slot_start:  # 判断是否类似a   XX 23:00:00 开始， 01:00:00 结束这样跨天的情况
...
b       if api.is_changing(klines.iloc[-1], "datetime"):
