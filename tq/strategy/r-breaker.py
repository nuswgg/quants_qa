...
from tqsdk import TqApi, TargetPosTask,TqBacktest,TqAuth

SYMBOL = "SHFE.cu2106"  # 合约代码
...
api = TqApi(backtest=TqBacktest(start_dt=date(2021, 3, 1), end_dt=date(2021, 3, 18)),web_gui="http://192.168.43.176:9876", auth=TqAuth("nuswgg", "541278"))
print("策略开始运行")
...
klines = api.get_kline_serial(SYMBOL, 60*5, 100)  # 86400: 使用日线
