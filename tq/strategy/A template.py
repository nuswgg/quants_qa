...
margin = get_margin(api, SYMBOL)
acct = api.get_account()
klines = api.get_kline_serial(SYMBOL, 60, 10)  # 86400: 使用日线
quote = api.get_quote(SYMBOL)
...
while True:
    ...
    target_pos_value = round(acct.available * 100 / (margin * price))
    print(quote.average)
