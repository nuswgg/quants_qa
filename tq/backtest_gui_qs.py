...
api = TqApi(backtest=TqBacktest(start_dt=date(2021, 3, 6), end_dt=date(2021, 3, 15)),web_gui="http://192.168.1.4:9877", auth=TqAuth("nuswgg", "541278"))
# 设定连续多少根阳线/阴线
length = 3
# 获得 ni2105 10秒K线的引用, 长度为 length+1
klines = api.get_kline_serial("SHFE.ni2105", 60, data_length=length + 1)
